// ============================================================
//  NEXUS — Custom Social Platform Icons (SVG)
//  Pure SVG components — zero external icon library dependency.
//  Each icon matches the official brand silhouette.
// ============================================================
...
/** Returns the matching icon component for a given platform string */
export function getPlatformIcon(platform: string, props: IconProps = {}) {
  const map: Record<string, React.ReactNode> = {
    ...
    TWITTER:   <TwitterXIcon {...props} />,
    TELEGRAM:  <TelegramIcon {...props} />,
    YOUTUBE:   <YouTubeIcon {...props} />,
    TIKTOK:    <TikTokIcon {...props} />,
    FACEBOOK:  <FacebookIcon {...props} />,
  };
  return map[platform.toUpperCase()] ?? <WebsiteIcon {...props} />;
}

/** Brand color mapping for platform icon backgrounds */
export const platformColors: Record<string, string> = {
  LINKEDIN:  'rgba(10, 102, 194, 0.25)',
  GITHUB:    'rgba(255, 255, 255, 0.12)',
  INSTAGRAM: 'rgba(225, 48, 108, 0.2)',
  WHATSAPP:  'rgba(37, 211, 102, 0.2)',
  PHONE:     'rgba(34, 211, 238, 0.2)',
  EMAIL:     'rgba(100, 81, 250, 0.2)',
  WEBSITE:   'rgba(255, 255, 255, 0.1)',
  TWITTER:   'rgba(255, 255, 255, 0.12)',
  TELEGRAM:  'rgba(36, 161, 222, 0.2)',
  YOUTUBE:   'rgba(255, 0, 0, 0.2)',
  TIKTOK:    'rgba(255, 0, 80, 0.2)',
