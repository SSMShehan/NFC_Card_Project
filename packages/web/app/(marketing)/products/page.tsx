      ...
      <div className="grid md:grid-cols-3 gap-8 mb-24">
        {products.map((product, idx) => (
          ...
          >
            ...
            <button className={`w-full py-4 rounded-xl font-bold text-lg transition-all ${product.popular ? 'bg-neutral-950 text-white hover:bg-neutral-900 hover:shadow-lg' : 'bg-neutral-100 text-neutral-950 hover:bg-slate-200'}`}>
              Customize & Order
            </button>
          </motion.div>
        ))}
